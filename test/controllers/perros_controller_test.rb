...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference('Perro.count') do
      post perros_url, params: { perro: { descripcion: @perro.descripcion, edad: @perro.edad, imagen: @perro.imagen, nombre: @perro.nombre } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { descripcion: @perro.descripcion, edad: @perro.edad, imagen: @perro.imagen, nombre: @perro.nombre } }
